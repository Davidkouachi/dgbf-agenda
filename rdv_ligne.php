                                ...
                                <div class="components-preview ">
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block nk-block-lg col-md-12">
                                            <a href="index.html" style="margin-bottom: 5px;" class="col-md-2 btn btn-dim btn-lg btn-warning text-center" >
                                                                    ...
                                                                    <table id="datatable" class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr class="nk-tb-item" style="font-size: 13px;">
                                                                                ...
                                                                                <td class="nk-tb-col tb-col-md">
                                                                                    <span>
                                                                                        <a href="rdv_ligne2.php?id_pres=<?php echo $elt_pres['id_pres']; ?>" class="btn btn-success btn-dim" >
