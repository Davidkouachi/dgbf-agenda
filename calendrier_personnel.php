...
$element_type_even=$req_type_even->fetchall();
    ...
    if ($_SESSION['poste']=='Secretaire' || $_SESSION['poste']=='Secretaire2') {
        ...
        $req_event=$bdd->prepare("SELECT * FROM agent,event,type_even,participe where participe.id_agent=agent.id_agent and participe.id_event=event.id_event and event.id_type_even=type_even.id_type_even and agent.dirige_agent='oui' and agent.id_hira=? ");
                                    ...
                                    <div class="nk-between">
                                        <div class="nk-block-head-content ">
                                            <h3 class="nk-block-title page-title" style="text-align: center; color: white;">
                                                CALENDRIER <?php 
                                                            if ($_SESSION['poste']=='Sous-Directeur' || $_SESSION['poste']=='Directeur' || $_SESSION['poste']=='Chef de Service' || $_SESSION['poste']=='Agent') {
                                                                echo " PERSONNEL";
                                                            }if ($_SESSION['poste']=='Secretaire2' ) {
                                                                echo " DU PERSONNEL SOUS-DIRECTEUR";
                                                            }if ($_SESSION['poste']=='Secretaire' ) {
                                                                echo " DU PERSONNEL DIRECTEUR";
                                                            } ?>
                                            </h3>
                                        </div>
                                        <!-- <div class="nk-block-head-content">
