		...
		<div class="container-login100" style="background-image: url('../../images/dgbf/bat 4.png'); background-position: button; background-size: cover; ">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="../../pages/auths/connexion_usager.php" method="POST" autocomplete="off">
					...
					<div class="wrap-input100 validate-input" data-validate = "Aucune données">
						<input class="input100" type="text" name="np_usager" autocomplete="off" placeholder="Nom et Prénom">
					...
					<div class="wrap-input100 validate-input" data-validate = "Aucune données">
						<input class="input100" type="text" name="tel_usager" autocomplete="off" placeholder="Contact">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
...
<!--===============================================================================================-->
	<script src="js/main.js"></script>
        ...
        <?php if(isset($_SESSION['erreur_admin'])=='oui') {?>
            <script>
                toastr.info("Vous Avez déjà un Compte","Notification",
