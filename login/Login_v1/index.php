		...
		<div class="container-login100" style="background-image: url('../../images/dgbf/bat 2.png'); background-position: button; background-size: cover; ">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="../../images/dgbf/logo de cote d'ivoire.png" alt="IMG">
				</div>

				<form class="login100-form validate-form" action="../../pages/auths/connexion_email.php" method="POST" autocomplete="off">
					<span class="login100-form-title">
						CONNEXION
					</span>

					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="email" name="email_agent" autocomplete="off" placeholder="Email">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="password" name="mdp_agent" autocomplete="off" placeholder="Mot de Passe">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" name="btn_se_connecter" type="submit">
							Se Connecter
						</button>
					</div>
					<br>
