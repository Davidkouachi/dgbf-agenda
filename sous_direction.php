    ...
    <body class="nk-body bg-lighter ">
                                                ...
                                                <form action="save/direction_plus.php" method="POST" class="form-validate">
                                                    <div class="row g-gs">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap ">
                                                                    <select class="form-select js-select2 text-center" name="id_parent" required="">
                                                                        <option value=" " selected>
                                                                            --- Sélectionner une direction ---
                                                                        </option>
                                                                        <?php foreach ($element as $elt) {?>
                                                        ...
                                                        <div class="col-md-12" style="text-align: center; justify-content:center;">
                                                            <div class="form-group ">
                                                                <button style="text-align: center; justify-content:center;" class="col-md-4 btn btn-dim btn-lg btn-success" type="submit" name="btn_sous_direction">
                                                                    Enregistrer
                                                                </button>
                                                            </div>
                                                        </div>
        ...
        <?php if(isset($_SESSION['notife'])=='existe') {?>
            <script>
                Swal.fire({
                    icon: "error",
                    title: "Cette Sous-Direction existe déja"
                })
            </script>
