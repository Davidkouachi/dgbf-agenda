    ...
    <body class="nk-body bg-lighter ">
                                                    ...
                                                    <div class="card-inner">
                                                        ...
                                                        <div class="tab-content mt-0">
                                                            ...
                                                            <div class="tab-pane <?php echo $etat1; ?>" id="thisyear">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-control-wrap ">
                                                                            <select class="form-select js-select2" name="id_parent" required="">
                                                                                <option value=" " selected>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input onkeyup="this.value=this.value.toUpperCase()" class="form-control text-center" id="fv-full-name" name="n_hira" required="" type="text"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input class="form-control text-center" id="fv-full-name" name="fax_hira" required="" type="text"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input class="form-control text-center" id="fv-full-name" name="tel_hira" required="" type="number"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    <input  class="form-control text-center" id="fv-full-name" name="email_hira" required="" type="text"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-12" style="text-align: center; justify-content:center;">
                                                                    <div class="form-group ">
                                                                        <button style="text-align: center; justify-content:center;" class="col-md-4 btn btn-dim btn-lg btn-success" type="submit" name="btn_service">
                                                                            Enregistrer
                                                                        </button>
                                                                    </div>
                                                                </div>
        ...
        <script>
            function myFunction(chosen){
                ...
                <?php 
                    if (isset($_POST['direction_select'])) {

                        $id_direction=$_POST['direction_select'];
                        $reqr=$bdd->prepare("SELECT * FROM direction  where id_direction=?");
                        $reqr->execute(array($id_direction));
                        $elementr=$reqr->fetchall();

                        foreach ($elementr as $eltr) {

                            $id_direction2=$eltr['id_direction'];
                            $req=$bdd->prepare("SELECT * FROM sous_direction where id_direction=?");
                            $req->execute(array($id_direction2));
                            $element=$req->fetchall();
                        }
                    }
                 ?>
        ...
        <?php if(isset($_SESSION['notife'])=='existe') {?>
            <script>
                Swal.fire({
                    icon: "error",
                    title: "Ce Service a déja un Chef"
                })
            </script>
