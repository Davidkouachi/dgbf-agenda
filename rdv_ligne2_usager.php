                                ...
                                <div class="components-preview wide-lg mx-auto">
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block nk-block-lg col-md-12">
                                            <a href="rdv_ligne_usager.php" style="margin-bottom: 5px;" class="col-md-3 btn btn-dim btn-lg btn-warning" >
                                                                    ...
                                                                    <div class="row g-gs">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="form-control-wrap">
                                                                                    <input onkeyup="this.value=this.value.toUpperCase()" class="form-control" id="fv-full-name" name="np_usager" required="" type="text" placeholder="Entrer votre Nom et Prénom" value="<?php echo $elt_usager['np_usager']; ?>" />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-3">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="form-control-wrap">
                                                                                    <input class="form-control" id="fv-full-name" name="email_usager" required="" type="text" placeholder="Entrer votre Email" value="<?php echo $elt_usager['email_usager']; ?>"/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="form-control-wrap">
                                                                                    <input class="form-control" id="fv-subject" name="tel_usager" required="" type="text" placeholder="Entrer votre Contact" value="<?php echo $elt_usager['tel_usager']; ?>"/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <?php } ?>
